...
制作者に関する質問に答えるRAGチャットを導入し**AWS S3 + CloudFront**に移行。

公開URL: [https://portfolio.yuremono.com/](https://portfolio.yuremono.com/)
...
│   ├── lib/
│   ├── pages/
│   └── styles/style.scss    # CustomClass を含むスタイルのエントリ（ビルドで読み込み）
├── js/                            # 参照用
...
[https://yuremono.github.io/BurnYourOwnStyle/](https://yuremono.github.io/BurnYourOwnStyle/)
...
公開URL: [https://yuremono.github.io/portfolio/](https://yuremono.github.io/portfolio/)
...
[https://github.com/yuremono/BurnYourOwnStyle/tree/react](https://github.com/yuremono/BurnYourOwnStyle/tree/react)