import{a as $,j as f}from"./maskMosaique-VSg3ctID.js";import{b as Se,I as Re}from"./Image-BANpvFGp.js";import{H as $e}from"./Header-DLvbijfl.js";import{u as _e,P as Ae}from"./useClientRuntime-Ox7wZmnE.js";import{F as ve}from"./Footer-DdiYUUAR.js";import{u as Ce}from"./useHtmlRootClass-C0I0DQ6X.js";import{g as Ie}from"./assetPath-BE5xjP8R.js";import"./main-CbIa-dob.js";import"./ArrowSquareOut.es-BZ5r3Twe.js";import"./IconBase.es-Bc54t43P.js";import"./CaretDown.es-tcHqmAbY.js";import"./CaretUp.es-BNktSTFV.js";const Pe=`---
id: summary01
label: 職務要約
category: 職務要約
title: 職務要約
...
`;function Q(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var v=Q();function pe(n){v=n}var _={exec:()=>null};function u(n,e=""){let t=typeof n=="string"?n:n.source,s={replace:(r,i)=>{let a=typeof i=="string"?i:i.source;return a=a.replace(x.caret,"$1"),t=t.replace(r,a),s},getRegex:()=>new RegExp(t,e)};return s}var qe=((n="")=>{try{return!!new RegExp("(?<=1)(?<!1)"+n)}catch{return!1}})(),x={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:n=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}>`)},Ge=/^(?:[ \t]*(?:\n|$))+/,Ze=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Oe=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,M=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Fe=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,W=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,ue=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,ge=u(ue).replace(/bull/g,W).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Qe=u(ue).replace(/bull/g,W).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),X=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,We=/^[^\n]+/,U=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Xe=u(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",U).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Ue=u(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,W).getRegex(),D="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Y=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Ye=u("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Y).replace("tag",D).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),de=u(X).replace("hr",M).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",D).getRegex(),Ve=u(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",de).getRegex(),V={blockquote:Ve,code:Ze,def:Xe,fences:Oe,heading:Fe,hr:M,html:Ye,lheading:ge,list:Ue,newline:Ge,paragraph:de,table:_,text:We},ne=u("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",M).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",D).getRegex(),Je={...V,lheading:Qe,table:ne,paragraph:u(X).replace("hr",M).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ne).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",D).getRegex()},Ke={...V,html:u(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Y).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:_,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:u(X).replace("hr",M).replace("heading",` *#{1,6} *[^
]`).replace("lheading",ge).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},et=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,tt=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ke=/^( {2,}|\\)\n(?!\s*$)/,nt=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,C=/[\p{P}\p{S}]/u,q=/[\s\p{P}\p{S}]/u,J=/[^\s\p{P}\p{S}]/u,rt=u(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,q).getRegex(),fe=/(?!~)[\p{P}\p{S}]/u,st=/(?!~)[\s\p{P}\p{S}]/u,it=/(?:[^\s\p{P}\p{S}]|~)/u,lt=u(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",qe?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),me=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,at=u(me,"u").replace(/punct/g,C).getRegex(),ot=u(me,"u").replace(/punct/g,fe).getRegex(),xe="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",ct=u(xe,"gu").replace(/notPunctSpace/g,J).replace(/punctSpace/g,q).replace(/punct/g,C).getRegex(),ht=u(xe,"gu").replace(/notPunctSpace/g,it).replace(/punctSpace/g,st).replace(/punct/g,fe).getRegex(),pt=u("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,J).replace(/punctSpace/g,q).replace(/punct/g,C).getRegex(),ut=u(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,C).getRegex(),gt="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",dt=u(gt,"gu").replace(/notPunctSpace/g,J).replace(/punctSpace/g,q).replace(/punct/g,C).getRegex(),kt=u(/\\(punct)/,"gu").replace(/punct/g,C).getRegex(),ft=u(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),mt=u(Y).replace("(?:-->|$)","-->").getRegex(),xt=u("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",mt).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),B=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,bt=u(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",B).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),be=u(/^!?\[(label)\]\[(ref)\]/).replace("label",B).replace("ref",U).getRegex(),we=u(/^!?\[(ref)\](?:\[\])?/).replace("ref",U).getRegex(),wt=u("reflink|nolink(?!\\()","g").replace("reflink",be).replace("nolink",we).getRegex(),re=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,K={_backpedal:_,anyPunctuation:kt,autolink:ft,blockSkip:lt,br:ke,code:tt,del:_,delLDelim:_,delRDelim:_,emStrongLDelim:at,emStrongRDelimAst:ct,emStrongRDelimUnd:pt,escape:et,link:bt,nolink:we,punctuation:rt,reflink:be,reflinkSearch:wt,tag:xt,text:nt,url:_},yt={...K,link:u(/^!?\[(label)\]\((.*?)\)/).replace("label",B).getRegex(),reflink:u(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",B).getRegex()},Z={...K,emStrongRDelimAst:ht,emStrongLDelim:ot,delLDelim:ut,delRDelim:dt,url:u(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",re).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:u(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",re).getRegex()},Tt={...Z,br:u(ke).replace("{2,}","*").getRegex(),text:u(Z.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},E={normal:V,gfm:Je,pedantic:Ke},z={normal:K,gfm:Z,breaks:Tt,pedantic:yt},St={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},se=n=>St[n];function S(n,e){if(e){if(x.escapeTest.test(n))return n.replace(x.escapeReplace,se)}else if(x.escapeTestNoEncode.test(n))return n.replace(x.escapeReplaceNoEncode,se);return n}function ie(n){try{n=encodeURI(n).replace(x.percentDecode,"%")}catch{return null}return n}function le(n,e){let t=n.replace(x.findPipe,(i,a,l)=>{let c=!1,o=a;for(;--o>=0&&l[o]==="\\";)c=!c;return c?"|":" |"}),s=t.split(x.splitPipe),r=0;if(s[0].trim()||s.shift(),s.length>0&&!s.at(-1)?.trim()&&s.pop(),e)if(s.length>e)s.splice(e);else for(;s.length<e;)s.push("");for(;r<s.length;r++)s[r]=s[r].trim().replace(x.slashPipe,"|");return s}function R(n,e,t){let s=n.length;if(s===0)return"";let r=0;for(;r<s&&n.charAt(s-r-1)===e;)r++;return n.slice(0,s-r)}function ae(n){let e=n.split(`
...
`)}const j=Object.entries(vt).map(([n,e])=>{const{data:t,content:s}=Ct(e),r=n.split("/").pop().replace(/\.md$/,""),i=d.parse(Lt(s),{async:!1}),a=Se.sanitize(i);return{id:t.id||r,label:t.label??"",category:t.category,title:t.title??"",dateTime:t.dateTime||"",image:t.image,priority:Pt(t.priority),bodyHtml:It(a),private:zt(t.private)}}).filter(n=>!n.private).sort((n,e)=>e.priority!==n.priority?e.priority-n.priority:e.dateTime.localeCompare(n.dateTime)),ce="/images/picsum/019.jpg",he=["職務要約"],Mt=[];function Et(){if(typeof window>"u")return 0;const n=getComputedStyle(document.documentElement).getPropertyValue("--head").trim();if(!n)return 0;const e=document.createElement("div");e.style.cssText=`position:absolute;visibility:hidden;height:${n};pointer-events:none;`,document.body.appendChild(e);const t=e.getBoundingClientRect().height;return e.remove(),t}function Xt(){const n=$.useRef(null);_e({rootRef:n}),Ce("[--head:6rem]");const[e,t]=$.useState(0),s=$.useRef([]),r=$.useMemo(()=>{const o=(j[e]?.image??ce).split(",").map(h=>h.trim()).filter(Boolean);return(o.length>0?o:[ce]).map(h=>Ie(h))},[e]),i=$.useMemo(()=>j.filter(l=>he.includes(l.category??"")),[]),a=$.useMemo(()=>{const l=Mt,c=he;return j.filter(o=>c.includes(o.category??"")?!1:l.length===0?!0:l.includes(o.category??""))},[]);return $.useEffect(()=>{const l=s.current.filter(h=>h!==null);if(!l.length)return;let c=null;const o=()=>{const h=Et(),g=window.innerHeight,m=Math.max(0,g-h);c?.disconnect(),c=new IntersectionObserver(k=>{const b=k.filter(w=>w.isIntersecting).map(w=>l.indexOf(w.target)).filter(w=>w!==-1);if(b.length===0)return;const I=Math.max(...b);t(w=>w===I?w:I)},{rootMargin:`-${h}px 0px -${m}px 0px`,threshold:0}),l.forEach(k=>c.observe(k))};o();const p=()=>o();return window.addEventListener("resize",p),()=>{c?.disconnect(),window.removeEventListener("resize",p)}},[]),f.jsxs(Ae,{ref:n,className:"[--HFF:--Ship] ",children:[f.jsx($e,{className:"LinkShadow UpInit "}),f.jsx("main",{id:"main-activity",className:"min-h-screen pt-[--head] pb-[--MY] [--itemH:calc(100lvh-var(--head)-var(--PX))]",children:f.jsxs("section",{className:"out Stick bp-lg  [--scr:100%] [--shift:100%] PX  [--wid:clamp(36em,50%,720px)] ",children:[f.jsxs("div",{className:"StickItem Cards col2 lg:[--gap:--wid] top-[--head] text-left lg:text-right lg:min-h-[--itemH]",children:[f.jsxs("div",{className:"item p-[--PX] bg-[--WH] BorderXY rounded-[--btnRad] content-center","aria-label":"記事の切り替え",children:[f.jsx("h1",{className:"h3FZ mb-4",children:"職務要約と活動記録"}),f.jsxs("nav",{className:"italic  ",children:[f.jsx("ul",{className:"space-x-3",children:i.map(l=>f.jsx("li",{className:"inline-block",children:f.jsx("a",{href:`#panel-${l.id}`,id:`tab-${l.id}`,className:"text-lg font-medium  underline",children:l.label})},l.id))}),f.jsx("ul",{className:"space-x-3",children:a.map(l=>f.jsx("li",{className:"inline-block ",children:f.jsx("a",{href:`#panel-${l.id}`,id:`tab-${l.id}`,className:"   underline",children:l.label})},l.id))})]})]}),f.jsx(Re,{figureClassName:"item gap-2 content-center lg:max-h-[--itemH] overflow-hidden",imgClassName:"max-h-full object-contain",image:r,alt:""})]}),f.jsx("div",{className:"StickScr  [--h3FZ:1.25em] pointer-events-none",children:f.jsx("div",{className:" w-[--wid]   mx-auto p-4 lg:p-0 pointer-events-auto",children:j.map((l,c)=>f.jsxs("article",{ref:o=>{s.current[c]=o},id:`panel-${l.id}`,className:"   scroll-mt-[--head] BorderB lg:min-h-[--itemH]","aria-labelledby":`tab-${l.id}`,children:[f.jsxs("header",{className:"sticky top-[--head] z-10 px-8  py-8 rounded-t-[--btnRad] bg-[--BC80] backdrop-blur-sm",children:[f.jsx("p",{className:"mb-2 text-sm sub",children:f.jsx("time",{dateTime:l.dateTime,children:l.dateTime})}),f.jsx("h2",{className:"h3FZ text-[--MC]",children:l.title})]}),f.jsx("div",{className:"px-8 mt-4 pb-12 MarkDown",dangerouslySetInnerHTML:{__html:l.bodyHtml}})]},l.id))})})]})}),f.jsx(ve,{})]})}export{Xt as default};
