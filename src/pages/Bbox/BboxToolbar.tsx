...
export default function BboxToolbar({
	...
	return (
			...
			<li className="NavLi">
				...
				<span
					className="h-5 w-px shrink-0 bg-GR/50"
					aria-hidden="true"
				/>
				...
				<div data-l="WidthPresets" className="flex flex-wrap items-center gap-1">
				...
				<span className="h-5 w-px shrink-0 bg-GR/50" aria-hidden="true" />
				<div data-l="SnapPresets" className="flex flex-wrap items-center gap-1">
					<span className="mr-0.5 whitespace-nowrap text-[11px] text-GR">
						Snap:
					</span>
					{[
				...
				<span className="h-5 w-px shrink-0 bg-GR/50" aria-hidden="true" />
				<div data-l="GuidePresets" className="flex flex-wrap items-center gap-1">
					<span className="mr-0.5 whitespace-nowrap text-[11px] text-GR">
						Guide:
					</span>
				...
				<div data-l="ToolbarEnd" className="ml-auto flex flex-wrap items-center gap-1">
					<BboxManualDialog />
					<button
						type="button"
						title={
