...
export function FutureNotice({
	...
	return (
		<div className="group/future relative">
			...
			<span
				className={[
					"duration-500 pointer-events-none absolute left-1/2 z-40 w-max max-w-48 -translate-x-1/2 BabelRightDown bg-WH px-2 py-1 text-center text-[0.625rem] leading-tight text-MC opacity-0   group-hover/future:opacity-100 ",
